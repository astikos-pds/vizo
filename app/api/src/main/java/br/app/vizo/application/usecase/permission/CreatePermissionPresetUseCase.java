...
import br.app.vizo.application.usecase.permission.request.CreatePermissionPresetRequestDTO;
...
public class CreatePermissionPresetUseCase {
    ...
    public PermissionPresetDTO execute(User loggedInUser, UUID municipalityId, CreatePermissionPresetRequestDTO request) {

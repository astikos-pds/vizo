    ...
    >
      ...
      <UCard color="neutral" variant="subtle" class="size-full">
        ...
        >
          ...
          >
            <UInput v-model="form.name" placeholder="Very memorable name" />
          </UFormField>
          ...
          <UFormField
            ...
            class="w-full flex justify-between items-center"
          >
            <USwitch v-model="form.canViewReports" />
          </UFormField>
          ...
          <UFormField
            ...
            class="w-full flex justify-between items-center"
          >
            <USwitch v-model="form.canUpdateStatus" />
          </UFormField>
          ...
          <UFormField
            ...
            class="w-full flex justify-between items-center"
          >
            <USwitch v-model="form.canManageUsers" />
          </UFormField>
        </div>
      </UCard>
    </UForm>
